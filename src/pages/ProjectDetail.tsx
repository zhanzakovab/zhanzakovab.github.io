...
const ProjectDetail = () => {
  ...
  // Find the case study post by slug
  const post = posts.find(p => p.slug === slug && p.type === 'case-study');
      ...
      <div className="space-y-8">
        <header className="space-y-4">
          ...
          <div className="flex items-start justify-between">
            <div>
              <span className="code-text text-xs uppercase tracking-wider text-purple-bright mb-2 block">
                case study
              </span>
              <h1 className="text-2xl font-medium text-foreground">
                {post.title}
